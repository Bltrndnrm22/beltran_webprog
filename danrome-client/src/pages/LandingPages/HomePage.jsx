...
const features = [
  {
    ...
    description: 'A student-focused navigation platform that helps users find classrooms, offices, and facilities easily using a simple and interactive map interface.',
    image: 'campus.png',
    button: { label: 'View Project', to: '/about' },
  },
  {
    title: 'Food Ordering App',
    description: 'An online food ordering system designed for students, allowing quick browsing, easy checkout, and a smooth ordering experience for everyday meals',
    image: 'food.png',
    button: { label: 'View Project', to: '/about' },
  },
  {
    title: 'Event Management System',
    description: 'A platform for organizing and managing school events, including scheduling, participant tracking, and real-time updates for better coordination.',
    image: 'event.jpg',
    button: { label: 'View Project', to: '/about' },
  },
];
                ...
                <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
                    ...
                    <div>
                        <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.28em] text-zinc-500">
                            Hello, Im Danrome Beltran
                        </p>
                        <h1 className="max-w-xl text-3xl font-bold leading-tight text-zinc-900 sm:text-4xl">
                            Designing simple digital experiences that feel clear, thoughtful, and easy to connect with.
                        </h1>
                        <p className="mt-4 max-w-lg text-sm leading-7 text-zinc-600 sm:text-base">
                            I turn ideas into clean and meaningful designs through research, simple content, and user-focused visuals that make every project feel intentional.
                        </p>
                        <div className="mt-6 flex flex-wrap gap-3">
                            <Button to="/about" variant="primary">About Me</Button>
                            <Button to="/articles" variant="secondary">View My Work</Button>
                        </div>
                    </div>
                            ...
                            <div className="aspect-4/3 overflow-hidden rounded-[1.25rem] bg-zinc-200">
                                {feature.image ? (
                                    ...
                                    <div className="flex h-full items-center justify-center">
                                        <p className="text-2xl font-semibold text-zinc-700">😶‍🌫️</p>
                                    </div>
                                )}
                            </div>
